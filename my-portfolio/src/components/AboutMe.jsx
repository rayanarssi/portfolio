            ...
            <div className="about-main">
                ...
                <div className="about-content">
                    ...
                    <p>
                        ...
                        design with strong functionality. While I don't have professional work
                        experience yet, I have completed multiple projects that allowed me to
                        apply my skills in real-world scenarios. My journey started with a
                        curiosity about how websites work, and it has grown into a passion for
                        creating seamless and user-friendly applications.
                    </p>
                    <p>
